...
export default function MedicalRecordsPageClient({ records }: MedicalRecordsPageClientProps) {
  return (
    <PageTransition className="m-auto min-h-screen w-full max-w-2xl bg-white">
      <div className="sticky top-0 z-10 grid grid-cols-3 items-center px-4 py-4">
        <BackButton />
        <p className="text-center text-lg font-medium text-nowrap md:text-xl">Medical Records</p>
        <div />
      </div>
